...
//    }
    ...
    public void create() {
        String templateFull = "\n/**\n" +
                "* This color constant \"`Name\" has RGBA8888 code {@code `RRGGBBAA}, hue `HUE, saturation `SAT, lightness `LUMA, and alpha `ALPHA.\n" +
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableRGB.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableHueRGB.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableValueRGB.html").writeString(sb.toString(), false);
