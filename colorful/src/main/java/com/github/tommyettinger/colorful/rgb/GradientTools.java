 ...
 * The intent is for the FloatArray to be used as a sequence of packed float RGB colors. You can create a new
...
public class GradientTools {
    ...
    /**
     * Creates a FloatArray gradient from the packed float RGB color {@code start} to the packed float RGB color
     ...
     * @param appending a FloatArray that will be appended to
     * @param steps how many steps the gradient should use; usually greater than 2
     * @param chain a FloatArray of packed float RGB colors that this will interpolate through in order
     * @return {@code appending}, after adding the gradient to the end
     */
