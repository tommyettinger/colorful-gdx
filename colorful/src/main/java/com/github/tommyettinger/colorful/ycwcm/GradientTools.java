 ...
 * The intent is for the FloatArray to be used as a sequence of packed float YCwCm colors. You can create a new
...
public class GradientTools {
    ...
    /**
     * Creates a FloatArray gradient from the packed float YCwCm color {@code start} to the packed float YCwCm color
     ...
     * @param appending a FloatArray that will be appended to
     * @param steps how many steps the gradient should use; usually greater than 2
     * @param chain a FloatArray of packed float YCwCm colors that this will interpolate through in order
     * @return {@code appending}, after adding the gradient to the end
     */
