...
*/
    ...
    /**
     * Expects an int color in the format (hue, 8 bits), (saturation, 8 bits), (lightness, 8 bits), (alpha, 7 bits),
     * (ignored, 1 bit).
     * @param color an int color with alpha in the least significant byte and hue in the most significant
     */
