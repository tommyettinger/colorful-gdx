...
//                    + ", decoded hue=" + ColorTools.hue(c) + ", decoded saturation=" + ColorTools.saturation(c) + ", decoded lightness=" + ColorTools.lightness(c)
        ...
        Gdx.files.local("ColorOutputIPT_HQ.txt").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleIPT_HQ.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleHueIPT_HQ.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleValueIPT_HQ.html").writeString(sb.toString(), false);
