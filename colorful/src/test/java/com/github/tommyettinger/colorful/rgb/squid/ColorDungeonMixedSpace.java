...
package com.github.tommyettinger.colorful.rgb.squid;
...
public class ColorDungeonMixedSpace extends ApplicationAdapter {
...
//		configuration.enableGLDebugOutput(true, System.out);
        ...
        new Lwjgl3Application(new ColorDungeonMixedSpace(seed), configuration);
    }
...
//    private TextureArrayColorfulBatch batch;
    ...
    public ColorDungeonMixedSpace() {
        this(1L);
    }

    public ColorDungeonMixedSpace(long seed) {
        this.seed = seed;
    }
...
//        rng = new ChopRandom(startTime);
        ...
        playerSprite.setTweakedColor(0.5f, 0.5f, 0.5f, 1f, 0.5f, 0.65f, 0.65f, 0.65f);
        ...
        for (int i = 0; i < numMonsters; i++) {
            ...
            monster.setTweak(0.55f, 0.55f, 0.55f, 0.6f);
...
//    }
    ...
    public void putMap() {
        ...
        float[][] lightLevels = vision.lighting.fovResult;
        batch.setTweak(0.45f, 0.4f, 0.4f, 0.4f);
