package com.github.tommyettinger.colorful.cielab.internal;
...
//                    + ", decoded hue=" + ColorTools.hue(c) + ", decoded saturation=" + ColorTools.saturation(c) + ", decoded lightness=" + ColorTools.lightness(c)
        ...
        Gdx.files.local("ColorOutputCIELAB.txt").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleCIELAB.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleHueCIELAB.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleValueCIELAB.html").writeString(sb.toString(), false);
