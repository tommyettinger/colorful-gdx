...
/**
 * A tool, not a demo, used to generate the data used in FullPalette and in the javadocs.
 * Created by Tommy Ettinger on 12/8/2019.
 */
public class FullPaletteCodeGenerator extends ApplicationAdapter {
    ...
    public static void main(String[] args) {
        ...
        new Lwjgl3Application(new FullPaletteCodeGenerator(), config);
    }
    public void create() {
        float c;
        String templateFull = "\n/**\n" +
...
//                    + ", decoded hue=" + ColorTools.hue(c) + ", decoded saturation=" + ColorTools.saturation(c) + ", decoded lightness=" + ColorTools.lightness(c)
        ...
        Gdx.files.local("ColorOutputFullOklab.txt").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableFullOklab.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableFullHueOklab.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableFullValueOklab.html").writeString(sb.toString(), false);
