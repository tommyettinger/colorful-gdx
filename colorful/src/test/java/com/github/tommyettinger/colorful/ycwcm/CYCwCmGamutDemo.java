...
/**
 * Experimenting with bringing non-linear brightness to YCwCm.
 */
public class CYCwCmGamutDemo extends ApplicationAdapter {
    ...
    public static void main(String[] arg) {
        ...
        config.setTitle("Curved YCwCm Gamut Demo");
        config.setWindowedMode(SCREEN_WIDTH, SCREEN_HEIGHT);
        config.setIdleFPS(10);
        config.setForegroundFPS(60);
        config.useVsync(true);

        final CYCwCmGamutDemo app = new CYCwCmGamutDemo();
...
//        // 24 is how many frames per second the animated GIF should play back at.
        gif.write(Gdx.files.local("CYCwCmGamut.gif"), pixmaps, 24);
...
//// 24 is how many frames per second the animated PNG should play back at.
        png.write(Gdx.files.local("CYCwCmGamut.png"), pixmaps, 24);
    }
