...
public class OklabColorizeDemo extends ApplicationAdapter {
...
//        config.setResizable(false);
        ...
        final OklabColorizeDemo app = new OklabColorizeDemo();
    ...
    public void create() {
        ...
        ShaderProgram shader = new ShaderProgram(Shaders.vertexShader, Shaders.fragmentShaderColorizeOklab);
