...
//                    + ", decoded hue=" + ColorTools.hue(c) + ", decoded saturation=" + ColorTools.saturation(c) + ", decoded lightness=" + ColorTools.lightness(c)
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleOklab.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleHueOklab.html").writeString(sb.toString(), false);
        ...
        sb.append("</table>\n</body>\n</html>");
        Gdx.files.local("ColorTableSimpleValueOklab.html").writeString(sb.toString(), false);
