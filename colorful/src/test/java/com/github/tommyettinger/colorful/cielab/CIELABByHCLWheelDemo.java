...
public class CIELABByHCLWheelDemo extends ApplicationAdapter {
...
//        config.setResizable(false);
        ...
        final CIELABByHCLWheelDemo app = new CIELABByHCLWheelDemo();
    ...
    public void create() {
        ...
        ShaderProgram shader = new ShaderProgram(Shaders.vertexShader, Shaders.fragmentShaderCielab);
...
//                if(g < dist) continue;
                ...
                batch.setPackedColor(ColorTools.cielabByHCL(angle, chr, layer, 1f));
