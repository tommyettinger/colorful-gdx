...
public class InvertLightnessDemo extends ApplicationAdapter {
...
//        config.setResizable(false);
        ...
        final InvertLightnessDemo app = new InvertLightnessDemo();
    ...
    public void create() {
        ...
        ShaderProgram shader = new ShaderProgram(Shaders.vertexShader, Shaders.fragmentShaderInvertedLightness);
        if(!shader.isCompiled()){
            System.out.println("Shader failed to compile: " + shader.getLog());
            shader = null;
        }
        colorizeBatch = new SpriteBatch(100, shader);
