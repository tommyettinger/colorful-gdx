...
import static com.github.tommyettinger.colorful.pure.oklab.ColorTools.fromRGBA8888;
import static com.github.tommyettinger.colorful.pure.oklab.ColorTools.toRGBA8888;
...
public class AlternatePaletteCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        sb.append("</table>\n</body>\n</html>");
        try {
            Files.write(Paths.get("ColorTableAlternateOklab.html"), sb.toString().getBytes(StandardCharsets.UTF_8));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        sb.append("</table>\n</body>\n</html>");
        try {
            Files.write(Paths.get("ColorTableAlternateHueOklab.html"), sb.toString().getBytes(StandardCharsets.UTF_8));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        sb.append("</table>\n</body>\n</html>");
        try {
            Files.write(Paths.get("ColorTableAlternateValueOklab.html"), sb.toString().getBytes(StandardCharsets.UTF_8));
        } catch (IOException e) {
            e.printStackTrace();
        }
