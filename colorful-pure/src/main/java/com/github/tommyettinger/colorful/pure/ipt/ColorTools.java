...
//		return (x - li); // (Math.min(li, 1f - li) + 1e-10f);
	 ...
	 * and opacity adjusted by the specified amounts. Note that this edits the color in HSL space, not IPT! Takes
	...
	/**
	 * Given a packed float IPT color {@code mainColor} and another IPT color that it should be made to contrast
	 * with, gets a packed float IPT color with I that should be quite different from {@code contrastingColor}'s I,
