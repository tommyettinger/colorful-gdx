 ...
 * The intent is for the FloatList to be used as a sequence of packed float IPT_HQ colors. You can create a new
...
public class GradientTools {
    ...
    /**
     * Creates a FloatList gradient from the packed float IPT_HQ color {@code start} to the packed float IPT_HQ color
     ...
     * @param appending a FloatList that will be appended to
     * @param steps how many steps the gradient should use; usually greater than 2
     * @param chain a FloatList of packed float IPT_HQ colors that this will interpolate through in order
     * @return {@code appending}, after adding the gradient to the end
     */
