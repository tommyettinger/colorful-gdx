 ...
 * <br>
 * This package offers a {@link com.github.tommyettinger.colorful.pure.oklab.SimplePalette} class like the one in the
 * ipt_hq package, and compatible with the same descriptions (though the resulting colors will be a little different).
 * Both IPT_HQ and Oklab are very good at mixing colors evenly, with Oklab probably a little better at it.
 * <br>
 * <ul>
